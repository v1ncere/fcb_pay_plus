...
class WalletButtonsRow extends StatelessWidget {
  const WalletButtonsRow({super.key, required this.accountNumber});
  final String accountNumber;

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HomeButtonsBloc, HomeButtonsState>(
