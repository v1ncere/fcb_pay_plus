        ...
        return Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  onPressed: () async => await showDatePicker(
                    ...
                    if(context.mounted) context.read<SignUpVerifyBloc>().add(BirthDateChanged(value ?? DateTime.now()));
                  }),
              ...
              onChanged: (value) => context.read<SignUpVerifyBloc>().add(BirthStringChanged(value))
            )
          ]
        );
      }
